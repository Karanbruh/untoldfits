      ...
      <div className="container-fluid px-3 px-sm-4 px-lg-5" style={{ maxWidth: '1440px' }}>
        <div className="row g-5 g-lg-4 pb-5">
          ...
          <div className="col-12 col-sm-6 col-md-4 col-lg-2">
            ...
            <nav className="d-flex flex-column">
              ...
              <Link to="/category/jackets" className={linkClass} style={linkStyle}>
                Outerwear
              </Link>
              <Link to="/products" className={linkClass} style={linkStyle}>
                Tops
              </Link>
              <Link to="/category/trackpants" className={linkClass} style={linkStyle}>
                Bottoms
              </Link>
              <Link to="/products" className={linkClass} style={linkStyle}>
                Accessories
        ...
        >
          ...
          <div className="d-flex gap-4 align-items-center">
            <a href="https://instagram.com" className="d-inline-flex" aria-label="Instagram">
              <img src={ASSETS.iconSocial1} alt="" width={20} height={20} />
            </a>
            <a href="https://x.com" className="d-inline-flex" aria-label="X">
              <img src={ASSETS.iconSocial2} alt="" width={20} height={20} />
            </a>
            <a href="https://facebook.com" className="d-inline-flex" aria-label="Facebook">
              <img src={ASSETS.iconSocial3} alt="" width={20} height={20} />
            </a>
          </div>
        </div>
      </div>
